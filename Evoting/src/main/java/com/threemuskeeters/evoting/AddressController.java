...
import com.threemuskeeters.evoting.util.JsfUtil;
import com.threemuskeeters.evoting.util.PaginationHelper;
...
public class AddressController implements Serializable {
    ...
    @EJB
    private com.threemuskeeters.evoting.AddressFacade ejbFacade;
